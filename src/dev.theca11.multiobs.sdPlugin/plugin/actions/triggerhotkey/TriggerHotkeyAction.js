 ...
 * @param {string} sequence The hotkey sequence string as saved in action settings (e.g. Control + Shift + KeyA)
 * @returns {{keyId?: string, keyModifiers: {control?: boolean, shift?: boolean, alt?: boolean, command?: boolean}}}
 * Object with key and modifiers as expected by OBS websocket request
 */
function parseSequenceString(sequence) {
	const data = { keyModifiers: {} };
 ...
 * @param {string} code {@link https://developer.mozilla.org/en-US/docs/Web/API/UI_Events/Keyboard_event_code_values | KeyboardEvent code string}
 * @returns {string} {@link https://github.com/obsproject/obs-studio/blob/master/libobs/obs-hotkeys.h | OBS key string}
 */
function jsKeyToObsKey(code) {
